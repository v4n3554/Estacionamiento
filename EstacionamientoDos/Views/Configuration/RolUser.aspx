<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Admin/Site.Master" AutoEventWireup="true" CodeBehind="RolUser.aspx.cs" Inherits="EstacionamientoDos.Views.Configuration.RolUser" %>
     ...
     <asp:Panel runat="server" ID="pnlPrincipal">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always" RenderMode="Block">
            <ContentTemplate>
                <div class="row">
                    <div class="col-md-3">
                        <asp:Button runat="server" CssClass="btn btn-primary" Text="Guardar" ID="btnGuardar" OnClick="btnGuardar_Click" ValidationGroup="ValidationRolUser" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
	                    ...
	                    ValidationGroup="ValidationRolUser"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <div class="right">
                                <asp:DropDownList runat="server" ID="ddlUsuario" CssClass="form-control select2bs4" data-live-search="true"></asp:DropDownList>
                            </div>
                        </div>
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlUsuario" 
	                    ValidationGroup="ValidationRolUser"
	                    ErrorMessage="Campo Requerido"
	                    CssClass="alert alert-danger" Font-Size="9"></asp:RequiredFieldValidator>
                    </div>
                        ...
                        <div class="card card-default">
                            <div class="card-body" style="height: auto; width: auto; overflow: auto; max-height: 800px;">
                                <asp:GridView ID="gvResume" runat="server" CssClass="table table-bordered table-hover table-striped"
                                    GridLines="None" AutoGenerateColumns="false" AllowPaging="false" DataKeyNames="idRolUser"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Usuario" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <span>
                                                    <asp:DropDownList runat="server" ID="ddlUserOper" CssClass="form-control select2bs4" data-live-search="true"></asp:DropDownList>
                                                </span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
